...
public class Agencia {
    ...
    //CONSTRUCTORES
    public Agencia(String direccion, String fax, String zonaActuacion) {
    ...
    public Agencia(String direccion, String fax, String zonaActuacion, Titular titular) {
        this(direccion, fax, zonaActuacion); // Llama al constructor de arriba para no repetir código
    ...
    public String getZonaActuacion() {
